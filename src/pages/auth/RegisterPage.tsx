...
export default function RegisterPage() {
  const { signUpWithEmail, signInWithGoogle, signInWithMicrosoft, signInWithLinkedin } = useAuth();
  ...
  const passwordStrength = (() => {
    ...
    if (score === 2) return { label: "Moyen", color: "bg-amber-500", width: "w-2/4" };
    if (score === 3) return { label: "Bon", color: "bg-blue-500", width: "w-3/4" };
