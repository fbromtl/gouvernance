                  ...
                  <div className="flex flex-col items-center gap-1.5 mt-5">
                    ...
                    <div className="flex items-center gap-4 mt-3">
                      ...
                      <svg width="16" height="16" viewBox="0 0 24 24" className="text-neutral-400">
                        <path fill="currentColor" d="M3 12V6.5l8-1.1V12H3zm0 5.5V12h8v6.6l-8-1.1zm9-12.4L21 3.5V12h-9V5.1zm0 7.9H21v8.5l-9-1.3V13z"/>
                      </svg>
                      {/* macOS */}
                      <svg width="16" height="16" viewBox="0 0 24 24" className="text-neutral-400">
                      ...
                      {/* Mobile/Android */}
                      <svg width="16" height="16" viewBox="0 0 24 24" className="text-neutral-400">
                        <path fill="currentColor" d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14zm-4.2-5.78v1.75l3.2-1.75L12.8 11.5v1.72z" />
