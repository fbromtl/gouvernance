        ...
        >
          <div className="text-center max-w-7xl mr-auto ml-auto pr-6 pl-6">
            ...
            <div className="max-w-6xl mx-auto">
              {/* Laptop screen bezel */}
              <div className="bg-[#1a1a1a] rounded-t-2xl p-[8px] pb-0 shadow-2xl shadow-black/20">
                {/* Browser chrome */}
                <div className="flex items-center gap-2 bg-[#2a2a2a] rounded-t-xl px-4 py-2.5">
                  {/* Traffic lights */}
                  ...
                  <div className="flex-1 flex justify-center">
                    <div className="flex items-center gap-2 bg-[#1a1a1a] rounded-lg px-4 py-1 max-w-sm w-full">
                      <Lock className="w-3 h-3 text-neutral-500" />
                      <span className="text-[11px] text-neutral-400">gouvernance.ai/dashboard</span>
                    </div>
                  </div>
                  <div className="w-[54px]" />
                </div>

                {/* Screen content — existing dashboard */}
              ...
              <div className="relative mx-auto">
                <div className="h-4 bg-gradient-to-b from-[#2a2a2a] to-[#3a3a3a] rounded-b-lg" />
                <div className="h-1.5 bg-[#2a2a2a] rounded-b-2xl mx-[15%]" />
              </div>
            </div>
