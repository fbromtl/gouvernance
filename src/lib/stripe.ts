...
export const PLANS: Record<PlanId, PlanDefinition> = {
  ...
  member: {
    ...
    monthlyPrice: 249,
    yearlyPrice: 2388,
    monthlyPriceId: 'price_1T7iKEGu82aZFyznGIZzX3ad',
    yearlyPriceId: 'price_1T7iKFGu82aZFyzngH7GPyRZ',
    maxMembers: 10,
    maxAiSystems: null,
    highlighted: true,
  ...
  expert: {
    ...
    monthlyPrice: 879,
    yearlyPrice: 8388,
    monthlyPriceId: 'price_1T7iKGGu82aZFyznASiSF75u',
    yearlyPriceId: 'price_1T7iKGGu82aZFyznaKBKD2Hj',
    maxMembers: null,
    maxAiSystems: null,
