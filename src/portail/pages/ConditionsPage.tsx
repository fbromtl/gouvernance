          ...
          <div className="border-t border-border/50 p-6 sm:p-8 space-y-4">
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              <div className="relative mt-0.5">
                ...
                />
                <div className="flex size-5 items-center justify-center rounded-md border-2 border-border peer-checked:border-brand-forest peer-checked:bg-brand-forest transition-colors">
