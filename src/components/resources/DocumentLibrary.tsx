    ...
    <>
      <section id="guides" className="py-16 sm:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            <Badge variant="outline" className="mb-4 rounded-full px-4 py-1.5 text-sm font-medium border-[#57886c]/20 text-[#57886c] bg-[#57886c]/5">
                        ...
                        >
                          <AccordionTrigger className="hover:no-underline py-5">
                            <div className="flex items-center gap-3 text-left">
                              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#57886c]/10 shrink-0">
...
function DocumentCard({ doc, onConsult, mode = "public" }: { doc: PublicDocument; onConsult: () => void; mode?: "public" | "portail" }) {
  return (
    <Card className="rounded-xl border-neutral-200 hover:border-[#57886c]/20 transition-colors">
      <CardContent className="p-4">
        <div className="flex items-start justify-between gap-4">
              ...
              <ul className="space-y-1 text-xs text-muted-foreground">
                {doc.summary_purpose && (
                  <li className="flex gap-1.5">
                    <span className="text-[#81a684] shrink-0">•</span>
          ...
          <Button
            variant="ghost"
            size="sm"
            className="shrink-0 gap-1 text-[#57886c] hover:text-[#466060] hover:bg-[#57886c]/5"
            onClick={onConsult}
          >
            {mode === "portail" ? (
