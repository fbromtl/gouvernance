---
title: "IA agentique sans gouvernance des données : le pari risqué de 64 % des entreprises"
slug: ia-agentique-deploiement-sans-fondations-mdm
date: "2026-03-11"
category: analyse
excerpt: "Deux entreprises sur trois déploient des agents IA autonomes sans fondations MDM. Une enquête Semarchy met en lumière un angle mort de gouvernance majeur : on ne peut pas construire des systèmes autonomes fiables sur des données qui ne le sont pas."
cover: /images/articles/ia-agentique-mdm.jpg
author: florian-brobst
featured: false
tags: "IA agentique, MDM, gouvernance des données, qualité des données, DataOps, dette technique, CDO, conformité"
---
...
Une enquête récente menée par Censuswide pour Semarchy vient poser des chiffres sur ce que beaucoup pressentaient. Et le constat est sans appel : **les investissements dans l'IA agentique progressent trois fois plus vite que la maturité des fondations de données** censées les alimenter. L'étude, qui cible des organisations de plus de 200 millions de dollars de chiffre d'affaires déjà engagées dans des projets IA, révèle un décalage structurel entre l'ambition affichée et la réalité opérationnelle.
...
1. IA agentique opérationnelle — **43 %**
2. DataOps et data products — **43 %**
3. Pilotes agentiques — **38 %**
4. Gestion des données — **37 %**
